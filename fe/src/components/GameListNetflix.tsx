...
export default function GameListNetflix({ username, role }: GameListNetflixProps) {
  const [categoriesWithGames, setCategoriesWithGames] = useState<GameCategory[]>([]);
                ...
                <div className="space-y-4">
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          ...
                          {getReplies(comment.id).map((reply) => (
                            <div key={reply.id} className="mt-3 ml-8 bg-gray-800 rounded-lg p-3">
                              <div className="flex items-start gap-2">
                                ...
                                <div className="flex-1">
                                  <div className="flex items-center gap-2 mb-1">
                                    <p className="font-bold text-sm">{reply.username}</p>
                                    <span className="text-xs text-gray-500">
                  ...
                  {comments.length === 0 && (
                    <div className="text-center py-12">
                      ...
                      <p className="text-gray-600 text-sm mt-1">Be the first to share what you think!</p>
                    </div>
                  )}
                </div>
              </div>
            ...
            <div className="space-y-6">
              <div className="bg-gray-800/50 rounded-lg p-6">
                ...
                <p className="text-gray-300 leading-relaxed">
                  {detailGame.description || detailGame.instructions || "No description available."}
                </p>
                {detailGame.category && (
              ...
              <div className="bg-gray-800/50 rounded-lg p-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-bold">{detailGame.createdBy || "Unknown"}</span>
                  </div>
    ...
    <div className="min-h-screen bg-gradient-to-b from-black via-gray-900 to-black text-white">
      ...
      <div className="relative h-96 bg-gradient-to-r from-purple-900 to-blue-900 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-8 h-full flex flex-col justify-center">
          <h1 className="text-5xl md:text-6xl font-bold mb-4">🎮 Game Center</h1>
          <p className="text-xl text-gray-300 max-w-2xl">
            Discover amazing games created by students. Play, learn, and have fun!
          </p>
          ...
          <div className="max-w-4xl mx-auto px-8 mb-12">
            <div className="bg-gray-900 rounded-lg p-8 shadow-2xl border border-gray-800">
              ...
              <form onSubmit={handleUpload} className="space-y-6">
                ...
                <div>
                  <label className="block font-bold mb-2">Game File (.html or .zip)</label>
                  <div
                  ...
                  >
                    ...
                    {file ? (
                      <>
                        ...
                        <p className="text-green-500 font-bold mb-2">{file.name}</p>
        ...
        <div className="space-y-12 pb-16 mt-36">
          {categoriesWithGames.length > 0 ? (
            ...
            <div className="text-center py-20 px-8">
              ...
              <p className="text-2xl font-bold text-gray-400 mb-2">No games available yet</p>
              <p className="text-gray-600">
                {username ? "Be the first to upload a game!" : "Sign in to start playing"}
              </p>
            </div>
          )}
        </div>
