...
export default function CategoryRow({ categoryName, categoryIcon, games, onGameClick }: CategoryRowProps) {
      ...
      {games.length === 0 ? (
        <div className="px-8">
          <div className="bg-gray-800/30 rounded-lg p-8 text-center border border-gray-700/50">
            <p className="text-gray-400 text-sm">No games in this category yet</p>
          </div>
        </div>
      ) : (
